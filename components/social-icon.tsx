  ...
  switch (icon) {
    ...
    case "github":
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path
            d="M12 3.8a8.3 8.3 0 0 0-2.6 16.2c.4.1.5-.2.5-.4v-1.5c-2 .4-2.5-.9-2.7-1.4-.1-.3-.5-1-.9-1.2-.4-.2-.9-.7 0-.7.8 0 1.4.7 1.6 1 .9 1.5 2.3 1.1 2.9.8.1-.6.4-1.1.6-1.3-1.8-.2-3.8-.9-3.8-4 0-.9.3-1.6.8-2.2-.1-.2-.4-1 .1-2 0 0 .7-.2 2.2.8a7.4 7.4 0 0 1 4 0c1.5-1 2.2-.8 2.2-.8.5 1 .2 1.8.1 2 .5.6.8 1.3.8 2.2 0 3.1-1.9 3.8-3.8 4 .3.2.6.8.6 1.6v2.4c0 .2.1.5.5.4A8.3 8.3 0 0 0 12 3.8Z"
            fill="currentColor"
          />
        </svg>
      );
